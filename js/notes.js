...
function setupTextFormatting() {
    ...
    document.querySelectorAll('.font-size-dropdown button').forEach(btn => {
        btn.addEventListener('click', function(e) {
            ...
            // استخدام fontSize مع قيمة مناسبة
            if (size === '12') {
...
function setupEventListeners() {
    ...
    // عرض الملاحظة عند النقر عليها في القائمة
    ...
    // دعم الإدخال في حقل العنوان عند الضغط على Enter
